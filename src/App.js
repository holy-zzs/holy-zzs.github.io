...
import { ThemeProvider } from './store/themeContext.js?v=tc1'

// 已有页面
import AuthModal from './components/auth/AuthModal.js?v=cb2'
import AuthView from './components/auth/AuthView.js?v=cb2'
import GameHall from './components/hall/GameHall.js?v=cb2'
import GamePlaza from './components/hall/GamePlaza.js?v=gp10'
// UploadView 已迁移为平台风格的 UploadPage（见下方 import）
import WorkspaceView from './components/platform/WorkspaceView.js?v=wsv11'
import StarVoyagerWorkbench from './components/platform/StarVoyagerWorkbench.js?v=svw1'
import AIStudio from './components/platform/AIStudio.js?v=as9'
// PreviewView 已迁移为平台风格的游戏播放器（HTML5 game player）
import PreviewView from './components/platform/PreviewView.js?v=pv3'

// 新平台页面（页面1-15）
import GameplayGacha from './components/platform/GameplayGacha.js?v=gg9'
...
import PlanDetailPage from './components/platform/PlanDetailPage.js?v=cb2'
import PreferencesPage from './components/platform/PreferencesPage.js?v=cb2'
import PresetTeamPage from './components/platform/PresetTeamPage.js?v=cb2'
...
import UploadPage from './components/platform/UploadPage.js?v=pdf20260717c'

// 新增平台页面
import AboutPage from './components/platform/AboutPage.js?v=cb2'
import AdminPage from './components/platform/AdminPage.js?v=cb2'
import BlogPage from './components/platform/BlogPage.js?v=cb2'
import ChangelogPage from './components/platform/ChangelogPage.js?v=cb2'
import ErrorPage from './components/platform/ErrorPage.js?v=cb2'
import FeedbackPage from './components/platform/FeedbackPage.js?v=cb2'
import InvitePage from './components/platform/InvitePage.js?v=cb2'
import LegalPage from './components/platform/LegalPage.js?v=cb2'
import NotificationsPage from './components/platform/NotificationsPage.js?v=cb2'
import PricingPage from './components/platform/PricingPage.js?v=cb2'
import SearchPage from './components/platform/SearchPage.js?v=cb2'
import SettingsPage from './components/platform/SettingsPage.js?v=cb2'
import StatusPage from './components/platform/StatusPage.js?v=cb2'
import { FeedbackButton } from './components/platform/PlatformCommon.js?v=nav4'

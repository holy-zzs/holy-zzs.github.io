...
import SettingsModal from './components/common/SettingsModal.js?v=cb1'
import { ErrorBanner, LoadingOverlay, Stepper, Toast } from './components/common/ui.js?v=cb1'
...
// 已有页面
import AuthModal from './components/auth/AuthModal.js?v=cb1'
import AuthView from './components/auth/AuthView.js?v=cb1'
import GameHall from './components/hall/GameHall.js?v=cb1'
import GamePlaza from './components/hall/GamePlaza.js?v=gp9'
// UploadView 已迁移为平台风格的 UploadPage（见下方 import）
import WorkspaceView from './components/platform/WorkspaceView.js?v=wsv10'
import StarVoyagerWorkbench from './components/platform/StarVoyagerWorkbench.js'
import AIStudio from './components/platform/AIStudio.js?v=as8'
...
import HelpPage from './components/platform/HelpPage.js?v=cb1'
import LandingPage from './components/platform/LandingPage.js?v=lp2'
import ModePage from './components/platform/ModePage.js?v=cb1'
import PlanDetailPage from './components/platform/PlanDetailPage.js?v=cb1'
import PreferencesPage from './components/platform/PreferencesPage.js?v=cb1'
import PresetTeamPage from './components/platform/PresetTeamPage.js?v=cb1'
import ProfilePage from './components/platform/ProfilePage.js?v=pp2'
import ProjectsPage from './components/platform/ProjectsPage.js?v=cb1'
import ProtocolDemo from './components/platform/ProtocolDemo.js?v=cb1'
import SubjectPage from './components/platform/SubjectPage.js?v=sp2'
import TeamBuilder from './components/platform/TeamBuilder.js?v=cb1'
import UploadPage from './components/platform/UploadPage.js?v=pdf20260716b'

// 新增平台页面
import AboutPage from './components/platform/AboutPage.js?v=cb1'
import AdminPage from './components/platform/AdminPage.js?v=cb1'
import BlogPage from './components/platform/BlogPage.js?v=cb1'
import ChangelogPage from './components/platform/ChangelogPage.js?v=cb1'
import ErrorPage from './components/platform/ErrorPage.js?v=cb1'
import FeedbackPage from './components/platform/FeedbackPage.js?v=cb1'
import InvitePage from './components/platform/InvitePage.js?v=cb1'
import LegalPage from './components/platform/LegalPage.js?v=cb1'
import NotificationsPage from './components/platform/NotificationsPage.js?v=cb1'
import PricingPage from './components/platform/PricingPage.js?v=cb1'
import SearchPage from './components/platform/SearchPage.js?v=cb1'
import SettingsPage from './components/platform/SettingsPage.js?v=cb1'
import StatusPage from './components/platform/StatusPage.js?v=cb1'
